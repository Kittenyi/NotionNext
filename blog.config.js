...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    'Hi，我是一个项目经理, Hi，我是一个投资者, 欢迎来到我的博客🎉',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Royisland', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '新能源从业 | Crypto student', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'royisland.xyz', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '生产力工具;行业动态', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'kittenyi0728@gmail.com', // 邮箱地址 例如mail@tangly1024.com
  ...
  POSTS_SHARE_SERVICES:
    ...
    'link,wechat,weibo,email,facebook,twitter,telegram,linkedin', // 分享的服務，按顺序显示,逗号隔开
  // 所有支持的分享服务：link(复制链接),wechat(微信),qq,weibo(微博),email(邮件),facebook,twitter,telegram,line,reddit,whatsapp,linkedin,vkshare,okshare,tumblr,livejournal,mailru,viber,workplace,pocket,instapaper,hatena
